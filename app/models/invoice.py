...
class Invoice(BaseModel, TimestampMixin):
    ...
    status = fields.CharField(
        ...
        default="draft",
        index=True,
        description="Statut: draft, sent, paid, partial, overdue, cancelled"
    )
    ...
    # Méthode de paiement
    payment_method = fields.CharField(max_length=50, null=True, description="Méthode: cash, check, credit_card, transfer, interac")
