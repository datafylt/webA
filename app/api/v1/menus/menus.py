...
@router.get("/list", summary="ViewMenuList")
async def list_menu(
...
@router.get("/get", summary="ViewMenu")
async def get_menu(
    menu_id: int = Query(..., description="Menuid"),
):
    result = await menu_controller.get(id=menu_id)
    return Success(data=result)


@router.post("/create", summary="CreateMenu")
...
@router.post("/update", summary="UpdateMenu")
...
@router.delete("/delete", summary="DeleteMenu")
async def delete_menu(
    id: int = Query(..., description="Menuid"),
):
